...
from eval_linear_probe import LinearProbe, _train_probe, _score_probe
...
def main(
    ...
    print("================================================")
    print(f"[+] OOD Linear Probe (wildjailbreak adversarial)")
    ...
    save_dict = {"layers": layers, "model": model, "token_pooling": token_pooling}
    for texts, key in [
